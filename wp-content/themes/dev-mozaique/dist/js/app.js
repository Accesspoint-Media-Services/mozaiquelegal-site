...
window.addEventListener('load', function () {
  ...
  aos__WEBPACK_IMPORTED_MODULE_2___default().init({
    ...
    once: true,
    offset: -100,
    // Negative value triggers even earlier
  ...
  var popup_contact_triggers = document.querySelectorAll('a[href="#popup-contact-trigger"]');
  if (popup_contact_triggers.length) {
    var contact_dialog = document.querySelector(".contact-dialog");
    if (contact_dialog) {
      ...
      var popup_closeButton = contact_dialog.querySelector(".dialog-close");
      popup_contact_triggers.forEach(function (popup_trigger) {
        popup_trigger.addEventListener("click", openDialog);
      });
      popup_closeButton.addEventListener("click", closeDialog);
      contact_dialog.addEventListener("click", function (event) {
  ...
  var petalElements = document.querySelectorAll('#theN g');
  if (petalElements.length > 0) {
    cycle('#theN g', 'active', 1000, 0);
  }

  // stacked products front page
  var stackedProducts = document.querySelector('.stacked-products');
  if (stackedProducts) {
    var cursor = document.querySelector('.custom-cursor');
    if (cursor) {
      var updateCursorState = function updateCursorState() {
        var rect = stackedProducts.getBoundingClientRect();
        var isOver = mouseX >= rect.left && mouseX <= rect.right && mouseY >= rect.top && mouseY <= rect.bottom;
        if (isOver) {
      ...
      var cursorLink = cursor.querySelector('a');
      var mouseX = 0;
      var mouseY = 0;
      ...
      var cards = stackedProducts.querySelectorAll('.product-card a');
      cards.forEach(function (card) {
        card.addEventListener('mouseenter', function () {
          var link = card.getAttribute('data-product-link');
          if (link && cursorLink) {
  ...
  if (reviewsSlider) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsSlider, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCards],
      autoplay: {
        delay: 12000,
        enabled: true,
  ...
  // Client Logos
  var clientLogos = document.querySelector('.swiper-client-logos');
  if (clientLogos) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](clientLogos, {
      loop: true,
  ...
  var aboutGalleryRow1 = document.querySelector('.swiper-about-gallery-row1');
  if (aboutGalleryRow1) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](aboutGalleryRow1, {
      loop: true,
      slidesPerView: 'auto',
      spaceBetween: 24,
      speed: 5000,
  ...
  var aboutGalleryRow2 = document.querySelector('.swiper-about-gallery-row2');
  if (aboutGalleryRow2) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](aboutGalleryRow2, {
      loop: true,
      slidesPerView: 'auto',
      spaceBetween: 24,
      speed: 5000,
  ...
  var frontPageCS = document.querySelector('.swiper-front-page-cs');
  if (frontPageCS) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](frontPageCS, {
      loop: true,
      slidesPerView: 1,
      autoplay: {
        delay: 4000,
  ...
  // Case studies
  var caseStudies = document.querySelector('.swiper-cs');
  if (caseStudies) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](caseStudies, {
      loop: true,
      slidesPerView: 1,
      autoplay: {
        delay: 4000,
  ...
  // Latest news
  var latestNews = document.querySelector('.swiper-latest-news');
  if (latestNews) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](latestNews, {
      loop: true,
      slidesPerView: 1,
      autoplay: true,
  ...
  // Product guide
  var productGuide = document.querySelector('.swiper-product-guide');
  if (productGuide) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](productGuide, {
      loop: false,
      slidesPerView: 1,
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var observer = new IntersectionObserver(function (entries) {
    ...
    entries.forEach(function (entry) {
      var entryIndex = Array.from(cards).indexOf(entry.target);
...
function _cycle() {
  _cycle = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(selector) {
    var className,
      ms,
      pause,
      nodes,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          className = _args.length > 1 && _args[1] !== undefined ? _args[1] : "active";
          ms = _args.length > 2 && _args[2] !== undefined ? _args[2] : 1000;
          pause = _args.length > 3 && _args[3] !== undefined ? _args[3] : 0;
          nodes = document.querySelectorAll(selector);
          origins = ['center bottom', 'center top', 'left center', 'right center', 'top left', 'top right', 'bottom left', 'bottom right'];
        case 5:
          if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkapwp"] = self["webpackChunkapwp"] || [];
