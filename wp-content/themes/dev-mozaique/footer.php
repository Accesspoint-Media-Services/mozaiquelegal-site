            ...
            <div class="flex flex-col lg:flex-row gap-y-6 lg:justify-between"> 
                <div class="relative justify-between flex flex-col gap-y-6">
                    ...
                    <div class="flex flex-wrap gap-x-6">
                        <a class="inline-flex !text-dark flex-row gap-x-2 items-center" href="https://uk.linkedin.com/company/accesspoint-legal-services" target="_blank">
                            LinkedIn <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
                        ...
                        <a class="inline-flex !text-dark flex-row gap-x-2 items-center" href="https://www.facebook.com/accesspoint.legal" target="_blank">
                            Facebook  
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
                            <path d="M0.422826 10.4905L12.3555 2.34809M12.3555 2.34809C12.3555 2.34809 11.1501 4.53072 11.0104 6.20182C10.8707 7.87291 11.2058 9.98305 11.2058 9.98305M12.3555 2.34809C12.3555 2.34809 10.1254 2.74677 8.27661 2.19546C6.42785 1.64414 4.8269 0.634876 4.8269 0.634876" stroke="#130668" stroke-width="1.5"/>
                            </svg>
                        </a>
                        <a class="inline-flex !text-dark flex-row gap-x-2 items-center" href="https://www.youtube.com/@accesspointlegal" target="_blank">
                            Youtube 
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
                            <path d="M0.422826 10.4905L12.3555 2.34809M12.3555 2.34809C12.3555 2.34809 11.1501 4.53072 11.0104 6.20182C10.8707 7.87291 11.2058 9.98305 11.2058 9.98305M12.3555 2.34809C12.3555 2.34809 10.1254 2.74677 8.27661 2.19546C6.42785 1.64414 4.8269 0.634876 4.8269 0.634876" stroke="#130668" stroke-width="1.5"/>
                            </svg>
                    ...
                    <div class="flex flex-wrap gap-6">
                        <a href="/privacy-policy/" class="footer-buttons">
                            Privacy Policy
                        </a>
                        <a href="/terms-and-conditions/" class="footer-buttons">
                            Terms & Conditions
                        </a>
                        <a href="/cookie-policy/" class="footer-buttons">
                            Cookie Policy
                        </a>
                    </div>
                ...
                <div class="flex lg:items-end flex-col gap-y-6">
                    ...
                    <a href="mailto:info@mozaique.legal">
                    ...
                    <img class="w-60 h-auto" src="/wp-content/uploads/2025/12/cyberEssentials.png" alt="">
    ...
    <div class="dialog-wrap">
        <div class="dialog-content h-full grid grid-cols-1 lg:grid-cols-[3.5fr_6.5fr] grid-rows-[auto_1fr] lg:grid-rows-1 gap-[calc(1.5vh+1.5vw)] lg:gap-[calc(3vh+3vw)] items-center">
            <div class="dialog-content-header bg-primary px-[calc(2vh+2vw)] py-[calc(2vh+2vw)] md:p-[calc(3vh+3vw)] rounded-3xl text-white h-full">
                ...
                <h2 class="dialog-content-header-title alt-heading h1 mb-4 md:mb-8 !text-white">Book a&nbsp;demo</h2>
